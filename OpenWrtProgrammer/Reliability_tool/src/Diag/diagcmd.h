...
#include "../packet/pkt.h"
#include "../Diag/jrddiagcmd.h"
...
public:
    ...
    TResult ReadCustModeName(QString & strModeName);
    TResult WriteSSID(QString strSSID);
    TResult ReadWifiPwdFlag(int &retFlagVal);
    TResult GenerateFTFiles();

    //add by jie.li 2012-06-27
    int32   EfsOpReadDelDir(bool bArmEfs, QString filename);
...
//#ifdef ATA_TPST
        ...
        TResult DIAG_ReadIMEI_9X25(QString & strImei);
//#endif
