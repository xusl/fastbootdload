...
tThreadsConfig [] =
{
    ...
    "Registry",     TFTPD32_REGISTRY,  AsyncSaveKeyBckgProc,  FALSE,  1024,           0,          0,     NULL,            NULL,  0,          NULL,                     TRUE,  FALSE, FALSE,
	"Scheduler",   TFTPD32_SCHEDULER,  Scheduler,             FALSE,  1024,           0,          0,     NULL,            NULL,  0,          NULL,                     TRUE,  FALSE, FALSE,
    ...
    "TFTP",      TFTPD32_TFTP_SERVER,  TftpdMain,             FALSE,  1024,   AF_UNSPEC,          0,   "tftp", & sSettings.Port, TFTP_PORT,  sSettings.szTftpLocalIP,  TRUE,   TRUE,  TRUE,
    "SNTP",      TFTPD32_SNTP_SERVER,  SntpdProc,		      FALSE,  1024,   AF_UNSPEC, SOCK_DGRAM,    "ntp",      & SntpdPort, SNTP_PORT,  "",                      FALSE,  FALSE,  TRUE,
    "DNS",       TFTPD32_DNS_SERVER,   ListenDNSMessage,      FALSE,  1024,   AF_UNSPEC, SOCK_DGRAM, "domain",        & DnsPort, DNS_PORT,   NULL,                    FALSE,  FALSE,  TRUE,
    "Syslog",  TFTPD32_SYSLOG_SERVER,  SyslogProc,            FALSE,  1024,   AF_UNSPEC, SOCK_DGRAM, "syslog",     & SyslogPort, SYSLOG_PORT,  "",                    FALSE,  FALSE,  TRUE,
};
