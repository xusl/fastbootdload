...
#ifdef _M_X64
#  define TFTPD_STRING   "TFTPD64 v4.52 Build " __DATE__ " " __TIME__
#  define TFTPD_ABOUT_TITLE   "About TFTPD64"
#else
#  define TFTPD_STRING   "TFTPD32 v4.52 Build " __DATE__ " " __TIME__
...
const char LICENSE_TFTPD32 [] =
"TFTPD32 and TFTPD64 are copyrighted 1998-2015 by Philippe Jounin (philippe@jounin.net) "
...
#  ifdef _M_X64
const char LICENSE_TFTPD32 [] =
"Tftpd64 Service Edition copyrighted 2007-2015 by Philippe Jounin\r\n";
#  else
const char LICENSE_TFTPD32 [] =
"Tftpd32 Service Edition copyrighted 2007-2015 by Philippe Jounin\r\n";
#  endif
#endif
